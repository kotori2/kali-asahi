...
mkfs.ext4 -O '^metadata_csum,^orphan_file' -U "${ROOT_UUID}" -L "kali-root" "${DISK_IMG_FILE}"
...
# Adjusting paths for Kali Linux
# Check the paths based on your Kali installation.
